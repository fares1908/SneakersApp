...
class CustomGridViewPopular extends GetView<HomePageControllerImpl> {
  const CustomGridViewPopular({
    super.key,
  });
  ...
  Widget build(BuildContext context) {
    ...
    return GridView.builder(
      ...
      gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
        ...
        crossAxisCount: 2,
        childAspectRatio: 2.05.sp,
      ),
      itemBuilder: (context, index) {
        return InkWell(
          onTap: () {
            controller.goToProductDetails(controller.items[index]);
            print( controller.items[index].itemsDesc);
          },
          child: Stack(
            children: [
              Card(
                  ...
                  child: GetBuilder<HomePageControllerImpl>(
                    builder: (controller) {
                      ...
                      return IconButton(
                        ...
                        icon: Icon(
                          controller.items[index].favorite == 1
                              ? IconlyBold.heart
                              : IconlyLight.heart,
                          size: 18,
                          color: AppColor.primaryColor,
